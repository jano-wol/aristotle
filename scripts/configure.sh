...
echo "  scripts/solve.sh   : Run Aristotle solver"
...
echo "  - problems/         : Your Lean theorem proving problems"
echo "  - solutions/        : Generated solutions from Aristotle"
echo "  - scripts/          : Shell scripts (solve.sh, status.sh)"
